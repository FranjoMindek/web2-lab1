    ...
    <div>
      ...
      <div className="top-0 left-0 w-full">
        <div className="flex items-center justify-between filter drop-shadow-md bg-slate-100 h-14 px-4">
            <a className="text-xl font-semibold" href="/">Utakmice demo web1-lab1</a>
            {!user  
              ? <div className="flex gap-4"><p className="text-xl font-semibold text-red-500">Nelogiran</p><a className="text-xl font-semibold" href="/api/auth/login">Login</a></div> 
              : <div className="flex gap-4"><p className="text-xl font-semibold text-green-500">{user?.role === 0 || user?.role === undefined ? 'Korisnik - ' : 'Admin - '}{user?.nickname}</p><a className="text-xl font-semibold" href="/api/auth/logout">Logout</a></div> 
            }
        </div>
      </div>
      {/* TABLICA */}
